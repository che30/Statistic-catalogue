...
it('Mocks the Fetchdata implementation', () => {
    ...
    const results = {
      avengers: {
        Search: [{
          ...
          Title: 'Ultimate Avengers: The Movie', Year: '2006', imdbID: 'tt0491703', Type: 'movie', Poster: 'https://m.media-amazon.com/images/M/MV5BMTYyMjk0NTMwMl5BMl5BanBnXkFtZTgwNzY0NjAwNzE@._V1_SX300.jpg',
        }, {
          ...
          Title: 'The Avengers', Year: '1961–1969', imdbID: 'tt0054518', Type: 'series', Poster: 'https://m.media-amazon.com/images/M/MV5BZWQwZTdjMDUtNTY1YS00MDI0LWFkNjYtZDA4MDdmZjdlMDRlXkEyXkFqcGdeQXVyNjUwNzk3NDc@._V1_SX300.jpg',
        }, {
          Title: 'Avengers Assemble', Year: '2012–2019', imdbID: 'tt2455546', Type: 'series', Poster: 'https://m.media-amazon.com/images/M/MV5BMTY0NTUyMDQwOV5BMl5BanBnXkFtZTgwNjAwMTA0MDE@._V1_SX300.jpg',
        }],
        totalResults: '115',
        Response: 'True',
      },
  ...
  expect(Fetchdata('https://www.omdbapi.com/?apikey=42852a78&s=avengers').Search[0].Title).toBe('The Avengers');
});
